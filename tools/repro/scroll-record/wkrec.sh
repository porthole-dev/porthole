...
TK_SCROLL_HOOK='sleep 20; setsid sh -c "sh /tmp/tk-wkphase.sh measure 16 > /tmp/wk-drag.out 2>&1; cp /tmp/wk.trace /tmp/wk-drag.trace; echo DRAGWINDOWDONE >> /tmp/wk-drag.out" </dev/null >/dev/null 2>&1 &' \
